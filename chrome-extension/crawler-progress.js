...
function handleCrawlComplete(result) {
  ...
  try {
    ...
    audio.volume = 0.3;
    // Autoplay may be blocked by browser policy - this is expected and non-critical
    audio.play().catch(() => { /* Autoplay blocked - expected */ });
  } catch (e) {
    // Audio creation failed - non-critical for UX
  }
}
